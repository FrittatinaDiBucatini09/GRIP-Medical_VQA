...
def configure_stage(stage: PipelineStage) -> StageConfig:
    ...
    if stage.key == "segmentation":
        ...
        # If mode includes step 1, ask for step 1 config
        ...
        # If mode includes step 2, ask for step 2 config
    ...
    # Only trigger the generic env-var prompt if segmentation didn't already configure it
