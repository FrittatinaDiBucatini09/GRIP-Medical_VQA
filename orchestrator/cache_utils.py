...
def cmd_check(args: argparse.Namespace) -> int:
    ...
    # 2. Check NER mismatch FIRST — it requires a destructive wipe of results,
    #    so it must be detected even when other conditions (dataset, config)
    #    also trigger a cache miss.
